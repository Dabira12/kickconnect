...
class RefundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create refund" do
    assert_difference("Refund.count") do
      post refunds_url, params: { refund: { description: @refund.description, resolved: @refund.resolved } }
    end
  ...
  test "should update refund" do
    patch refund_url(@refund), params: { refund: { description: @refund.description, resolved: @refund.resolved } }
